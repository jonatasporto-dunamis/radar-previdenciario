...
export type LeadMediumEmailProps = {
  payload: LeadNotificationPayload;
};

export function LeadMediumEmail({ payload }: LeadMediumEmailProps) {
  return createElement(
    ...
    createElement(
      Preview,
      null,
      "Novo lead de medio potencial no Radar Previdenciario",
    ),
    createElement(
      Body,
      ...
      createElement(
        ...
        createElement(Header, {
          title: "Novo lead de medio potencial",
          subtitle:
            "Um lead concluiu a analise e apresentou alguns elementos de atencao.",
        }),
        createElement(
          Section,
          { title: "Dados do lead" },
...
export default LeadMediumEmail;
